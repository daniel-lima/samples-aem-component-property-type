package com.acme.samples.aem.componentpropertytype.it.launcher;
...
implements SlingRemoteTestParameters, SlingTestsCountChecker {
    ...
    public static final String TEST_SELECTOR = "com.acme.samples.aem.componentpropertytype.it.tests";
